...
static bool add_table_status_fields(Select_lex_builder *query,
  ...
  static const LEX_CSTRING field_data_persistence_threshold = {STRING_WITH_LEN("DATA_PERSISTENCE_THRESHOLD")};
  static const LEX_CSTRING alias_data_persistence_threshold = {STRING_WITH_LEN("Data_persistence_threshold")};
  ...
  if (alias_as_alias == false) {
    if (query->add_select_item(field_engine, alias_engine) ||
        ...
        query->add_select_item(field_data_persistence_threshold, alias_data_persistence_threshold) ||
    ...
    if (query->add_select_item(alias_engine, alias_engine) ||
        ...
        query->add_select_item(alias_data_persistence_threshold, alias_data_persistence_threshold) ||
